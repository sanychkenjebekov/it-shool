...
const Cards = () => {
    ...
    return (
        <div id='karty'>
            ...
            <div className="vyhod" style={{position:'absolute',left:'12.5%',top:'70%',textAlign:'center',color:'white',background:'rgb(11 22 57)',padding:'30px 76px',borderRadius:'10px',display:'none'}}>
